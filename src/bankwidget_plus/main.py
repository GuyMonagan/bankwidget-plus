...
def main() -> None:
    """
    Запускает пользовательский интерфейс в командной строке.

    Загружает данные из Excel-файла и предоставляет
    интерактивное меню с несколькими опциями:
      1 — фильтрация данных по дате;
      2 — генерация отчёта по дням недели;
      3 — простой поиск по описанию транзакций;
      0 — выход из программы.

    Ввод пользователя обрабатывается в бесконечном цикле
    до тех пор, пока не будет выбран выход.
    """
